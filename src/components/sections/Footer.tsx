...
export function Footer() {
  return (
    <footer className="w-full fixed bottom-0 left-0 z-50 bg-transparent py-2 px-4 mb-4">
      {/* Desktop: match the main layout structure exactly */}
      <div className="hidden md:block">
        <div className="grid grid-cols-[140px_1fr] w-full">
          {/* Empty space to match aside */}
          <div />
          {/* Content area with left padding to match main */}
          <div className="pl-16">
            <div className="max-w-4xl mx-auto w-full flex justify-center items-center gap-6 text-sm">
      ...
      <div className="md:hidden max-w-4xl mx-auto w-full flex justify-center items-center gap-6 text-sm">
        {contactMethods.map((method) => {
          let IconComponent = icons[method.icon];
          if (method.icon === "GitHub") {
            IconComponent = () => (
